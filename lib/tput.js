...
Tput.prototype.getRootPath = function() {
  const [gbPath]= process.argv
  const rootPath = path.join(path.dirname(path.dirname(gbPath)),'lib','node_modules','gitboard-cli','node_modules','gitboard-cli-blessed','usr') 
